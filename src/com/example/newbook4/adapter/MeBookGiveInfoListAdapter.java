...
public class MeBookGiveInfoListAdapter extends BaseAdapter {
	private static final String TAG = "SubjectListAdapter";
	private Context mContext;
	private List<BookGiveInfoBean> mList;
	private String mAddress;
	private final LayoutInflater mInflater;
	private Typeface type = null;

	public MeBookGiveInfoListAdapter(Context context,
			List<BookGiveInfoBean> list, MyListView listView, String address) {
	...
	public View getView(final int position, View view, ViewGroup parent) {
		...
		if (view == null) {
			view = mInflater.inflate(R.layout.listview_mebookgiveinfo_item,
					null);
		...
		BookGiveInfoBean bookGiveInfoBean = mList.get(position);
		//holder.title.setText(bookGiveInfoBean.obtain_bookname);
		holder.msg.setText(getStr(bookGiveInfoBean.obtain_msg));
		holder.time.setText(getTime(bookGiveInfoBean.generate_time));
		String imgUrl = mAddress + bookGiveInfoBean.release_picture;
