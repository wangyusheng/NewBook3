...
public class MeGiveBookListActivity extends BaseActivity {
	private static final String TAG = "MeGiveBookListActivity";
	...
	private void initViewComponent() {
		...
		((TextView) findViewById(R.id.actionbar_tv)).setText("图书-赠送");
